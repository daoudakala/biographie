...
function arlo_tm_animate_text() {
    ...
    animateSpan.typed({ strings: [ "Développeur web ", "UX Designer","Community manager"], loop: true, startDelay: 1e3, backDelay: 2e3 });
}
...
function arlo_tm_down() {
    ...
    jQuery(".arlo_tm_arrow_wrap a").on("click", function () {
        if ($(".arlo_tm_topbar").length) {
            if ($.attr(this, "href") !== "#") {
                $("html, body").animate({ scrollTop: $($.attr(this, "href")).offset().top - topbar + 3 }, 800);
            }
        } else {
            if ($.attr(this, "href") !== "#") {
        ...
        jQuery(this)
            .on("mouseenter", function () {
                ...
                jQuery(document).on("mousemove", function (e) {
                    jQuery(".arlo_tm_portfolio_titles").css({ left: e.clientX - 10, top: e.clientY + 25 });
                });
            })
